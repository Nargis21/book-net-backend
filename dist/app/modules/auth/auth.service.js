...
const getAuth = (token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    //verify token
    try {
        verifiedToken = jwtHelpers_1.jwtHelpers.verifyToken(accessToken, config_1.default.jwt.secret);
    }
    catch (error) {
        throw new ApiError_1.default(http_status_1.default.FORBIDDEN, 'Invalid token');
    }
    const user = yield user_model_1.User.findById(verifiedToken._id);
    return {
        user: user,
    };
});
